...
const ContractTenderForm = () => {
    ...
    function generateContractId(contractType, year, existingIds) {
        const filteredIds = existingIds.filter(id => id.startsWith(`${contractType}/${year}/`));
        const maxId = filteredIds.length > 0 ? Math.max(...filteredIds.map(id => parseInt(id.split("/")[2]))) : 0;
                        ...
                        <Form>
                            ...
                            <Row className="mb-3">
                                <Form.Group
                                    ...
                                    className="mb-3"
                                >
                                    <Form.Select defaultValue="Choose..." value={contractType}
                                        onChange={handleContractTypeChange} className="border-0">
