                                        ...
                                        <tbody>
                                            {rowsData.map((row, index) => (
                                                <tr key={index}>
                                                    <td>{row.srNo}</td>
                                                    <td>
                                                        <Form.Group as={Col} lg={10} controlId={`itemtype_${row.srNo}`} >
                                                    ...
                                                    <td>
                                                        <Button variant="Secondary" type="submit" className="btn border ">
                                                            <small className="d-flex">+ Document (pdf, jpg)</small>
                                                        </Button>
                                                    </td>
                                                </tr>
                                            ))}
